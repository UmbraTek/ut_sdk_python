...
class UbotReportStatus(threading.Thread):
...
class UbotReportStatus10HZ(UbotReportStatus):
    def __init__(self, ip):
        ...
        """
        UbotReportStatus.__init__(self, ip, 30001)


class UbotReportStatus100HZ(UbotReportStatus):
    def __init__(self, ip):
        """This class will create a new thread to connect to ubot and receive the status of ubot at a frequency of 100HZ
        The status is as follows:
            see the UbotReportStatus10HZ

        Args:
            ip (String): IP address of UTRA robotic arm
        """
        UbotReportStatus.__init__(self, ip, 30002)

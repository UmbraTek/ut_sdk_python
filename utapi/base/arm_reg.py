...
class ARM_REG:
    def __init__(self, axis):
        ...
        self.MOVET_P2P = [0x33, null, null, null, null]
        self.MOVET_P2PB = [0x34, null, null, null, null]
        self.MOVEJ_LINE = [0x35, null, null, null, null]
        self.MOVEJ_LINEB = [0x36, null, null, null, null]
        self.MOVEJ_CIRCLE = [0x37, null, null, null, null]
        ...
        self.TCP_JERK = [0x40, 0, 4, 4, 0]
        self.TCP_MAXACC = [0x41, 0, 4, 4, 0]
        self.JOINT_JERK = [0x42, 0, 4, 4, 0]
        self.JOINT_MAXACC = [0x43, 0, 4, 4, 0]
        ...
        self.CAL_IK = [0x52, 24, AXIS * 4, null, null]
        self.CAL_FK = [0x53, AXIS * 4, 24, null, null]
        self.IS_JOINT_LIMIT = [0x54, AXIS * 4, 1, null, null]
        self.IS_TCP_LIMIT = [0x55, 24, 1, null, null]

        self.UTRC_INT8_NOW = [0x60, 3, 2, 4, 1]  # [line id reg] [ret value] [line id reg value] [ret]
        self.UTRC_INT32_NOW = [0x61, 3, 5, 7, 1]
        self.UTRC_FP32_NOW = [0x62, 3, 5, 7, 1]
        self.UTRC_INT8N_NOW = [0x63, 4, 0x55, 0x55, 1]

        self.UTRC_INT8_QUE = [0x64, ' ', ' ', 4, 0]  # [line id reg] [ret value] [line id reg value] [ret]

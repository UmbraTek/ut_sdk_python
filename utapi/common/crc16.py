...
CRC_TABLE_H = (0x00, 0xC1, 0x81, 0x40, 0x01, 0xC0, 0x80, 0x41, 0x01, 0xC0, 0x80,
...
CRC_TABLE_L = (0x00, 0xC0, 0xC1, 0x01, 0xC3, 0x03, 0x02, 0xC2, 0xC6, 0x06, 0x07,
...
def crc_modbus(data):
    ...
    while leng > 0:
        ...
        leng -= 1
    crc16 = init_crch << 8 | init_crcl
    crc = bytes([crc16 // 256 % 256])
    crc += bytes([crc16 % 256])
    return crc
